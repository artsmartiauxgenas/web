...
hero:
  ...
  text: 
  tagline: Karaté Shotokan · Self-Défense · Karaté Mix — ouvert à tous dès 5 ans
  actions:
    - theme: brand
...
features:
  - icon: 🌱
    title: Dès 5 ans, tous niveaux
    details: Enfants, ados, adultes et seniors — chacun progresse à son rythme dans une ambiance bienveillante.
  - icon: 🥋
    title: 6 cours par semaine
    details: Du lundi au samedi, dans les équipements municipaux de Genas — Karaté Shotokan, Self-Défense, Body Karaté, Karaté Mix.
  - icon: 🤝
    title: Un club depuis 1993
    details: Plus de 100 adhérents, une équipe bénévole engagée et des professeurs diplômés d'État.
---
...
### 🥋 [Karaté Fitness & Défense](/docs/disciplines/karate-fitness-defense)

Trois pratiques complémentaires — Karaté Défense, Body Karaté et Karaté Mix — dans une ambiance sans compétition ni contact dur. Pour se défouler, retrouver la forme ou développer des réflexes d’autodéfense. À partir de 16 ans, sans niveau requis.
