...
|:------:|-----------------------------------------------|----------------------------------------------|
| 706    | Cotisations des membres                       | Cotisations annuelles enfants/adultes        |
| 707    | Prestations de services                       | Stages, cours à l’unité, démonstrations      |
| 708    | Autres produits d’activités                   | Ventes ponctuelles (goodies, boissons)       |
| 740    | Subventions d’exploitation                    | Subventions de la mairie, ANS, etc.          |
| 754    | Dons manuels                                  | Dons reçus sans contrepartie                 |
| 758    | Produits divers de gestion courante           | Intérêts bancaires, remboursements, etc.     |

### 📤 Dépenses (classe 6)

| Compte | Intitulé                                      | Utilisation                                  |
|:------:|-----------------------------------------------|----------------------------------------------|
| 601    | Achats stockés (matériel durable)             | Tatamis, mannequins, grands équipements      |
| 606    | Achats non stockés (petit matériel)           | Fournitures, petit équipement                |
| 615    | Entretien et réparations                      | Équipements, locaux                          |
...
| 658    | Charges diverses                              | A utiliser en dernier recours (à éviter)     |

### 🧾 Comptes de capitaux (classe 1)

| Compte | Intitulé                                      | Utilisation                                  |
|:------:|-----------------------------------------------|----------------------------------------------|
| 101    | Fonds associatif sans droit de reprise        | Apport initial, autofinancement              |
| 1068   | Réserves statutaires ou affectées             | Affectation volontaire d’un excédent         |
| 120    | Résultat de l’exercice (excédent)             | Excédent comptable annuel                    |
| 129    | Résultat de l’exercice (déficit)              | Déficit comptable annuel                     |

### 🧾 Comptes de tiers (classe 4)

| Compte | Intitulé                                      | Utilisation                                  |
|:------:|-----------------------------------------------|----------------------------------------------|
| 401    | Fournisseurs                                  | Prestataires à payer                         |
| 411    | Clients / adhérents                           | Créances cotisations ou stages               |
| 421    | Personnel (salarié)                           | Si présence de salariés                      |
| 437    | URSSAF, organismes sociaux                    | Charges sociales éventuelles                 |
| 455    | Membres / bénévoles                           | Avances ou remboursements                    |
...
| 531    | Caisse                                        | Espèces (éviter autant que possible)         |

### 💡 Contributions volontaires (classe 8)

| Compte | Intitulé                                      | Utilisation                                  |
|:------:|-----------------------------------------------|----------------------------------------------|
| 870    | Bénévolat valorisé                            | Comptabilisation indicatrice                 |
| 875    | Mise à disposition gratuite de locaux         | Ex. Dojo mis à dispo par la commune          |
